...
from .mobilenet_helper import Block, conv_bn
...
# Adapted from: https://github.com/okankop/Efficient-3DCNNs/blob/master/models/mobilenet.py
@MODEL_REGISTRY.register()
class MobileNet(nn.Module):
    def __init__(self, cfg):
        ...
        self.width_mult = cfg.MODEL.WIDTH_MULT
    ...
    def _construct_network(self, cfg):
        """
        Builds a single pathway MobileNet model.

        Args:
            cfg (CfgNode): model building configs, details are in the
                comments of the config file.
        """
        input_channel = int(self.input_channel * self.width_mult)
        last_channel = int(self.last_channel * self.width_mult)
        cfg = [
        # c, n, s
        [64,   1, (2,2,2)],
        [128,  2, (2,2,2)],
        ...
        self.classifier = nn.Sequential(
            nn.Dropout(self.dropout), #0.2 originally
            #nn.Dropout(0.2),
