...
_C.PRUNING.ENABLE = False

_C.PRUNING.GLOBAL = False

_C.PRUNING.ISOMORPHIC = False
...
_C.PRUNING.CHECKPOINT_FILE_PATH = ""

_C.PRUNING.CHECKPOINT_TYPE = 'pytorch'

_C.PRUNING.EVALUATE_AFTER_FINE_TUNNING = True
